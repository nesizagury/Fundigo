...
public class Menu extends AppCompatActivity {
    ...
    protected String currentUser;//Assaf
    protected String phoneNum; //assaf
    protected InputStream picStream; //assaf
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!number.isEmpty ()){
            ...
            user_profile_button.setVisibility(View.VISIBLE);//Assaf: if already registered then button is visible
        }
    ...
    protected void onResume() {
        ...
        //Assaf: when back to Menu page , hide the table profile Presented
    ...
    public void getUserProfile(View view) { //Assaf: get onclick event for pulling the user profile
         ...
         //String _userPhoneNumber = "1-555-521-5554";
         //String _userPhoneNumber = "972527959455";
         //String _userPhoneNumber = "972123456";
